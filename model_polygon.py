...
#             label = labels[labels['ShapeID'] == shape_id]['is_regular_polygon'].values[0]
...
# # Save the model
# model.save('models/cnn_model_polygon.h5')
...
# model = tf.keras.models.load_model('models/cnn_model_polygon.h5')
 
# # Example usage
# test_file_path = 'shapes/square_irregular_01.csv'
...
# # Save the model
# model.save('models/cnn_model_polygon1.h5')
